...
// import { clerkClient } from '@clerk/nextjs'
// import { onMailer } from '../mailer'
// import Gemini from 'gemini-sdk' // Replace with actual SDK import if available
...
//             })
//           }
//           return { live: true, chatRoom: checkCustomer.customer[0].chatRoom[0].id }
//         }

//         const chatCompletion = await gemini.generateChatCompletion({
//           messages: [
//             {
//               role: 'assistant',
//               content: `Use the following questions to guide the conversation: ${chatBotDomain.filterQuestions
//                 .map((q) => q.question)
//                 .join(', ')}. Add "(complete)" to questions you ask.`,
//             },
//             ...chat,
...
//         if (chatCompletion.content?.includes('(realtime)')) {
//           await client.chatRoom.update({
//             where: { id: checkCustomer.customer[0].chatRoom[0].id },
//             data: { live: true },
//           })
...
//           const response = {
//             role: 'assistant',
//             content: chatCompletion.content.replace('(realtime)', ''),
//           }
...
//         if (chatCompletion) {
//           const link = extractURLfromString(chatCompletion.content)?.[0]
//           const response = {
//             role: 'assistant',
//             content: link
//               ? `Great! You can follow the link to proceed: ${link}`
